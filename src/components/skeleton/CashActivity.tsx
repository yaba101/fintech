...
const CashActivitySkeleton = () => {
  return (
    <>
      <StatsSkeleton />
      <div className="my-3 animate-pulse rounded-md border border-gray-900 bg-gray-50 p-4 shadow-md dark:bg-dark dark:text-gray-100">
        <div className="border-bottom flex justify-between">
          <div className="flex items-center">
            <div className="mb-2 h-4 w-20 rounded bg-gray-500" />
          </div>
          <div className="h-4 w-20 rounded bg-gray-500" />
        </div>

        {/* Placeholder for the HalfDonutChart */}
        <div className="mb-16 h-40 w-full rounded bg-gray-500 " />
        ...
        <div className="mb-6 ml-6 flex justify-between">
          <div className="h-4 w-10 bg-gray-500" />
          <div className="h-4 w-10 bg-gray-500" />
        </div>

        <div className="mx-auto mb-3 h-10 w-32 rounded bg-gray-500" />
      </div>
    </>
  );
};
